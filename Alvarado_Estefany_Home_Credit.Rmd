...
# Step 3: Handling Missing Data and Imputation Strategies
...
print(outlier_counts)
```
# Step 6: Data Preprocessing and Feature Alignment
...
# Step 8: Model Implementation and Handling Class Imbalance
...
kable(comparison_table, caption = "Comparison of Naive Bayes Models with Various Sampling Methods")
```
...
# Display the table using kable
kable(comparison_table_2, caption = "Comparison of Random Forest, XGBoost, and LightGBM Models")
```
...
# Display the table using kable
kable(comparison_table_3, caption = "Comparison of Logistic Regression Models with SMOTE and ROSE")
...
# Display the table using kable
kable(comparison_table_4, caption= "Comparison of Logistic Regression Models")
...
kable(importance, caption = "Top 10 Features Based on Importance")
...
comparison_table_5 <- data.frame(
  ...
  Optimal_Threshold =  c(NA, NA, 0.5037)  # Optimal threshold for adjusted
)


# Display the comparison table using kable
kable(comparison_table_5, caption = "Comparison of LightGBM Models with Metrics")
```
...
kable(risk_summary, caption = "Summary of Loans and Default Probabilities by Risk Category")
...
kable(top_20_predictors, caption = "Top 20 Predictors Based on Importance")
```
...
```{r}
# Display personas_table using kable with corrected column names
kable(personas_table, caption = "Personas Table with Key Characteristics")
...
kable(profitability_personas, caption = "Combined Results of Profitability Personas")
```
